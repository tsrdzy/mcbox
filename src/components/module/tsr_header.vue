    ...
    <header id="header">
        <div class="header_left">
            ...
            <ul class="nav iconfont">
                <!-- <li><router-link to="/" active-class="main_active"><b>&#xe639;</b> 首页</router-link></li> -->
                <li><router-link to="/" active-class="main_active"><b>&#xe629;</b> 工具</router-link></li>
                <li><router-link to="/resource" active-class="main_active"><b>&#xe888;</b> 资源</router-link></li>
                <li><router-link to="/about" active-class="main_active"><b>&#xe622;</b> 关于</router-link></li>
            </ul>
        </div>
        ...
        <div class="set_button iconfont">
            ...
            <div class="skin">
                <h2 tabindex="-1" class="iconfont" v-on:blur="this.header_skin_select = false"
                    v-on:click="this.header_skin_select = !this.header_skin_select">&#xe617;</h2>
            ...
            <div v-if="this.main_max" v-on:click="tounmax(id)" style="font-size: 16px">
                &#xe653;
            </div>
